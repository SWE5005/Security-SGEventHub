...
public class ManageUserController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<?> deleteUser(Principal principal,@PathVariable @Valid @NotNull String userId) {
        log.info("[UserController:deleteUser]Request to delete user started for user: ",principal.getName());
        try {
