...
//            if (user.getEmailAddress() != null && !isEncrypted(user.getEmailAddress())) {
//                user.setEmailAddress(converter.convertToDatabaseColumn(user.getEmailAddress()));
//            }
            if (user.getMobileNumber() != null && !isEncrypted(user.getMobileNumber())) {
                user.setMobileNumber(converter.convertToDatabaseColumn(user.getMobileNumber()));
            }
